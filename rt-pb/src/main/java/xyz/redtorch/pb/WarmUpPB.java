	...
	static public void start(){
		...
		try {
			...
			for(int i = 0;i < 11000; i++) {
				GatewayField gatewayField = GatewayField.newBuilder()
				...
				ContractField contractField = ContractField.newBuilder()
				...
				List askPriceList = new ArrayList<Double>();
				...
				List bidPriceList = new ArrayList<Double>();
				...
				List askVolumeList = new ArrayList<Integer>();
				...
				List bidVolumeList = new ArrayList<Integer>();
